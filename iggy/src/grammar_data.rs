...
// Rule { "@Start", "@NoLayout", EOF, Identifier, "@Regex", "@Layout", LineComment,
// "@WithLayout", WS }
...
// Rule { "@Start", "@NoLayout", Identifier, "@Regex", "@Layout", "@WithLayout", LineComment,
// WS }
...
// Rule : . SyntaxRule { "@Start", Identifier, "@NoLayout", "@Layout", "@WithLayout",
// LineComment, WS }
...
// SyntaxRule { "@Start", "@NoLayout", EOF, Identifier, "@Regex", "@Layout", LineComment,
// "@WithLayout", WS }
...
// SyntaxRule : . Opt_1 Layout head:Identifier Layout "=" Layout Star_1 { "@Start",
// Identifier, "@NoLayout", "@Layout", "@WithLayout", LineComment, WS }
...
// RegexRule { "@Start", "@NoLayout", EOF, Identifier, "@Regex", "@Layout", LineComment,
// "@WithLayout", WS }
...
// PostCondition { LineComment, "@Start", "\\", "@NoLayout", EOF, Identifier, "@Regex",
// "@Layout", "!>>", "@WithLayout", WS }
...
// PriorityLevel { ">", "@Start", "@NoLayout", EOF, Identifier, "@Regex", "@Layout",
...
// Associativity { ">", "@Start", String, "@NoLayout", EOF, "{", Identifier, "(", "@Regex",
...
// Alternative { ">", "@Start", "@NoLayout", "|", EOF, Identifier, "@Regex", "@Layout",
// LineComment, "@WithLayout", WS }
...
// Symbol { "?", ">", "@Start", "*", "@WithLayout", Label, EOF, "!", Identifier, "(", ")",
...
// Regex { "?", "[", "@Start", "*", "@WithLayout", EOF, Identifier, "(", "!", ")", "!>>",
...
// CharClass { "?", "[", "@Start", "*", "@WithLayout", EOF, Identifier, "(", "!", ")", "!>>",
// "@Layout", "@Regex", Char, String, "@NoLayout", "|", "+", LineComment, "\\", WS }
...
// Layout { "left", "@Start", "[", "?", ":", Label, "!<<", Identifier, "!", "!>>", "right",
// Char, "@NoLayout", "|", "-", "}", "@WithLayout", LineComment, WS, "none", "]", "=", "*",
...
// Plus_0 { "@Start", "@NoLayout", EOF, Identifier, "@Regex", "@Layout", LineComment,
// "@WithLayout", WS }
...
// Plus_0 { "@Start", "@NoLayout", Identifier, "@Regex", "@Layout", "@WithLayout",
// LineComment, WS }
...
// Plus_0 : . Plus_0 Layout Rule { "@Start", "@NoLayout", Identifier, "@Regex", "@Layout",
...
// Plus_0 : . Rule { "@Start", "@NoLayout", Identifier, "@Regex", "@Layout", "@WithLayout",
// LineComment, WS }
...
// Opt_0 { "@Start", "@NoLayout", Identifier, "@Regex", "@Layout", "@WithLayout",
// LineComment, WS }
...
// Opt_0 : . Plus_0 { "@Start", "@NoLayout", Identifier, "@Regex", "@Layout", "@WithLayout",
// LineComment, WS }
...
// Star_0 { "@Start", "@NoLayout", Identifier, "@Regex", "@Layout", "@WithLayout",
// LineComment, WS }
...
// Star_0 : . Opt_0 { "@Start", "@NoLayout", Identifier, "@Regex", "@Layout", "@WithLayout",
// LineComment, WS }
...
// Plus_1 { WS, "@Start", "@NoLayout", EOF, Identifier, "@Regex", "@Layout", LineComment,
// "@WithLayout", ">" }
...
// Opt_2 { "@Start", "@NoLayout", EOF, Identifier, "@Regex", "@Layout", LineComment,
// "@WithLayout", WS }
...
// Star_1 { "@Start", "@NoLayout", EOF, Identifier, "@Regex", "@Layout", LineComment,
// "@WithLayout", WS }
...
// Plus_3 { "[", "@Start", "@WithLayout", EOF, Identifier, "(", "!", ")", "!>>", "@Layout",
...
// Plus_2 { WS, "@Start", "@Layout", "@NoLayout", "@WithLayout", "|", EOF, Identifier,
// "@Regex", ")", LineComment, "\\", "!>>" }
...
// Plus_4 { WS, "@Start", "@WithLayout", "@NoLayout", EOF, Identifier, "@Regex", "@Layout",
// LineComment, "\\", "!>>" }
...
// Opt_5 { "@Start", "@NoLayout", EOF, Identifier, "@Regex", "@Layout", LineComment,
// "@WithLayout", WS }
...
// Star_2 { "@Start", "@NoLayout", EOF, Identifier, "@Regex", "@Layout", LineComment,
// "@WithLayout", WS }
...
// Opt_6 { ">", "@Start", String, "@NoLayout", EOF, "{", Identifier, "(", "@Regex",
// "@Layout", LineComment, "@WithLayout", WS }
...
// Plus_5 { WS, "@Start", "@NoLayout", "|", EOF, Identifier, "@Regex", "@Layout",
...
// Opt_7 { ">", "@Start", "@NoLayout", EOF, Identifier, "@Regex", "@Layout", LineComment,
// "@WithLayout", WS }
...
// Star_3 { WS, "@Start", "@NoLayout", EOF, Identifier, "@Regex", "@Layout", LineComment,
// "@WithLayout", ">" }
...
// Plus_6 { WS, "@Start", Label, EOF, Identifier, "(", "@Regex", ")", "@Layout", String,
...
// Opt_8 { WS, "@Start", "@NoLayout", "|", EOF, Identifier, "@Regex", "@Layout", LineComment,
// "@WithLayout", ">" }
...
// Group_0 { "?", ">", "@Start", "*", "@WithLayout", Label, EOF, "!", Identifier, "(", ")",
// "!>>", "@Regex", "@Layout", String, "@NoLayout", "|", "{", "+", "}", LineComment, "\\", WS
// }
...
// Plus_8 { "?", ">", "@Start", "*", "@WithLayout", Label, EOF, "!", Identifier, "(", ")",
// "!>>", "@Regex", "@Layout", String, "@NoLayout", "|", "{", "+", "}", LineComment, "\\", WS
// }
...
// Group_1 { "?", ">", "@Start", "*", "@WithLayout", Label, EOF, Identifier, "(", "!", ")",
// "!>>", "@Regex", "@Layout", String, "@NoLayout", "|", "{", "+", "}", LineComment, "\\", WS
// }
...
// Plus_9 { "?", ">", "@Start", "*", "@WithLayout", Label, EOF, Identifier, "(", "!", ")",
// "!>>", "@Regex", "@Layout", String, "@NoLayout", "|", "{", "+", "}", LineComment, "\\", WS
// }
...
// Group_2 { "?", ">", "@Start", "*", "@WithLayout", Label, EOF, "!", Identifier, "(", ")",
// "!>>", "@Regex", "@Layout", String, "@NoLayout", "|", "{", "+", "}", LineComment, "\\", WS
// }
...
// Plus_10 { "?", ">", "@Start", "*", "@WithLayout", Label, EOF, "!", Identifier, "(", ")",
// "!>>", "@Regex", "@Layout", String, "@NoLayout", "|", "{", "+", "}", LineComment, "\\", WS
// }
...
// Alt_0 { "left", "@Start", "[", "?", ":", Label, "!<<", Identifier, "!", "!>>", "right",
// Char, "@NoLayout", "|", "-", "}", LineComment, "@WithLayout", "none", "]", WS, "=", "*",
// RangeChar, EOF, "@Regex", "(", "@Layout", ")", String, "{", "+", "grammar", "\\", ">" }
...
// Plus_12 { "left", "@Start", "[", "?", ":", Label, "!<<", Identifier, "!", "!>>", "right",
// Char, "@NoLayout", "|", "-", "}", LineComment, "@WithLayout", "none", "]", WS, "=", "*",
// RangeChar, EOF, "@Regex", "(", "@Layout", ")", String, "{", "+", "grammar", "\\", ">" }
...
// Opt_10 { "left", "@Start", "[", "?", ":", Label, "!<<", Identifier, "!", "!>>", "right",
// Char, "@NoLayout", "|", "-", "}", "@WithLayout", "none", "]", "=", "*", RangeChar, EOF,
...
// Star_4 { "left", "@Start", "[", "?", ":", Label, "!<<", Identifier, "!", "!>>", "right",
// Char, "@NoLayout", "|", "-", "}", "@WithLayout", "none", "]", "=", "*", RangeChar, EOF,
// "@Regex", "(", "@Layout", ")", String, "{", "+", "grammar", "\\", ">" }
...
// StartRule { "@Start", "@NoLayout", Identifier, "@Regex", "@Layout", LineComment,
// "@WithLayout", WS }
...
// StartRule : . Layout start:Rule Layout { "@Start", "@NoLayout", Identifier, "@Regex",
// "@Layout", LineComment, "@WithLayout", WS }
...
// StartSyntaxRule { "@Start", Identifier, "@NoLayout", "@Layout", LineComment,
// "@WithLayout", WS }
...
// StartSyntaxRule : . Layout start:SyntaxRule Layout { "@Start", "@NoLayout", Identifier,
// "@Layout", LineComment, "@WithLayout", WS }
...
// StartAnnotation { "@Start", "@NoLayout", "@Layout", LineComment, "@WithLayout", WS }
...
// StartAnnotation : . Layout start:Annotation Layout { "@Start", "@NoLayout", "@Layout",
// LineComment, "@WithLayout", WS }
...
pub static FIRST_SET_START_POST_CONDITION: TerminalSet = TerminalSet {
    id: 23,
    terminals: &[TerminalId(7), TerminalId(9), TerminalId(22), TerminalId(23)],
};
...
pub static FIRST_SET_START_POST_CONDITION_ALT0: TerminalSet = TerminalSet {
    id: 56,
    terminals: &[TerminalId(22), TerminalId(9), TerminalId(23), TerminalId(7)],
};
