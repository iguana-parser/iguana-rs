...
electronic submission: the CLA Assistant check on your pull request asks you to
sign with your GitHub account, which records your identity, the agreement
version, and the date. This is a legally binding document, so please read it
...
version of this document ([CLA-ENTITY.md](https://github.com/iguana-parser/iguana-rs/blob/main/CLA-ENTITY.md)). If You are less
...
This Agreement is executed electronically. Agreeing through the CLA Assistant
check on a pull request records your GitHub identity, the agreement version,
and the date, and constitutes your signature.

If your contributions are covered by an Entity Contributor License Agreement
([CLA-ENTITY.md](https://github.com/iguana-parser/iguana-rs/blob/main/CLA-ENTITY.md)), your signature operates as acknowledgment of
that coverage, and rights in employer-owned material are granted under that
entity agreement rather than this one.

---

This document is based on the Harmony Individual Contributor License
Agreement (HA-CLA-I) Version 1.0, July 4, 2011, available at
...
alternative in Section 2.2 is resolved to "You", the non-owner instructions
point to CONTRIBUTING.md, the Material definition names each crate or package
in LICENSE.md, and the remainder of the repository, as separate Materials with
their licenses recorded there, Section 3(c) links the entity version
(CLA-ENTITY.md), the disclaimer and damage waiver in Sections 4 and 5 are made
mutual (following the wording of the companion HA-CAA-I template), and the
submission instructions and paper signature block are replaced by electronic
execution, with a sentence coordinating signatures with entity coverage.
