...
Thank you for your interest in contributing to iguana-rs, a project managed by
Ali Afroozeh ("We" or "Us").

This contributor agreement ("Agreement") documents the rights granted by
contributors to Us. To make this document effective, please sign it and send
it to Us by electronic submission: email a signed copy to
<afroozeh@gmail.com>, naming the legal entity, the signer's name and title,
and the GitHub accounts of the employees it covers. This is a legally binding document, so
...
the "Licensing of contributions" section of [CONTRIBUTING.md](https://github.com/iguana-parser/iguana-rs/blob/main/CONTRIBUTING.md).
...
After You Submit the Contribution, it may be included in the Material. For
iguana-rs, each crate or package listed in [LICENSE.md](https://github.com/iguana-parser/iguana-rs/blob/main/LICENSE.md), and the
remainder of the repository as described there, is a separate Material, and
the license or licenses in use for each are recorded there.
...
to grant, now or in the future, You grant to Us a perpetual, worldwide,
non-exclusive, transferable, royalty-free, irrevocable patent license, with
the right to sublicense these rights to multiple tiers of sublicensees, to
...
In addition, We may use any license for Media in the Contribution (including
...
(d) You have followed the instructions in the "Licensing of contributions"
section of [CONTRIBUTING.md](https://github.com/iguana-parser/iguana-rs/blob/main/CONTRIBUTING.md), if You do not own the Copyright
...
laws of the Netherlands excluding its conflicts of law provisions. Under
...
This Agreement is executed by emailing a signed copy to Us at
<afroozeh@gmail.com>, naming the legal entity, the signer's name and title,
and the GitHub accounts of the employees whose contributions it covers. The
signer must be authorized to bind the Legal Entity. Covered employees still
complete the CLA Assistant check on their pull requests; as stated in the
individual agreement, that signature acknowledges their coverage under this
Agreement. The covered list may be updated by later email from an authorized
signer.

---

This document is based on the Harmony Entity Contributor License Agreement
(HA-CLA-E) Version 1.0, July 4, 2011, available at
<https://www.harmonyagreements.org/> and licensed under the [Creative Commons
Attribution 3.0 Unported License](https://creativecommons.org/licenses/by/3.0/).
Changes from the original: the project and owner names are filled in, the
governing-law jurisdiction in Section 6.1 is filled in as the Netherlands,
Option Five of Section 2.3 is selected as the outbound license, the
media-license list is resolved to "any license", the "[or Your Affiliates]"
alternative in Section 2.2 is resolved to include Affiliates, the non-owner
instructions point to CONTRIBUTING.md, the Material definition names each
crate or package in LICENSE.md, and the remainder of the repository, as
separate Materials with their licenses recorded there, the disclaimer and
damage waiver in Sections 4 and 5 are made mutual (following the wording of
the companion HA-CAA-E template), and the submission instructions and paper
signature block are replaced by signed email execution, with sentences
requiring an authorized signer, coordinating employee signatures, and allowing
later updates to the covered list.
