...
impl<'i, 'arena> Parser<'i, 'arena> for PlusGroupParser<'i, 'arena> {
    ...
    fn build_tree<'a>(&self, root: SPPFNodeId, tree_arena: &'a Arena) -> ParseTree<'a> {
        let builder = PlusGroupParseTreeBuilder::new(tree_arena);
    ...
    fn execute(
        ...
        match slot_id {
            ...
            SlotId(24) => {
                let nonterminal_node_id =
                    self.create_nonterminal_node(result, NonterminalId(9), SlotId(24), gss_node_id);
    ...
    fn follow_set_terminals(&self, nonterminal_id: NonterminalId) -> Vec<TerminalId> {
        match nonterminal_id {
            ...
            NonterminalId(5) => FOLLOW_SET_PLUS_0.terminals.to_vec(),
            NonterminalId(6) => FOLLOW_SET_START_S.terminals.to_vec(),
            NonterminalId(7) => FOLLOW_SET_START_A.terminals.to_vec(),
            NonterminalId(8) => FOLLOW_SET_START_B.terminals.to_vec(),
            NonterminalId(9) => FOLLOW_SET_START_C.terminals.to_vec(),
            _ => vec![],
        }
    }
...
pub struct PlusGroupParser<'i, 'arena> {
    ...
    intermediate_nodes_index: [InlineMap<'arena, Span, SPPFNodeId>; 25],
...
impl<'i, 'arena> PlusGroupParser<'i, 'arena> {
    ...
    pub fn new(input: &'i Input, parser_arena: &'arena Arena) -> Self {
        ...
        Self {
            vec_arena,
            scanner: PlusGroupScanner::new(input, vec_arena),
