...
use crate::{
    grammar::*,
    parse_tree::{self, LabeledFollowRestrictionParseTreeBuilder, ParseTree, create_parse_tree},
    scanner::LabeledFollowRestrictionScanner,
};
...
impl<'i, 'arena> LabeledFollowRestrictionParser<'i, 'arena> {
    ...
    pub fn new(input: &'i Input, parser_arena: &'arena Arena) -> Self {
        ...
        Self {
            vec_arena,
            scanner: LabeledFollowRestrictionScanner::new(input, vec_arena),
