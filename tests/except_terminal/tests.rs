...
// To update golden files: REGENERATE=1 cargo test -p iguana-tests --test grammar_tests except_terminal::
...
const GRAMMAR_DIR: &str = concat!(env!("CARGO_MANIFEST_DIR"), "/tests/except_terminal");
