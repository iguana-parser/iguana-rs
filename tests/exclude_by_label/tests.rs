...
// To update golden files: REGENERATE=1 cargo test -p iguana-tests --test grammar_tests exclude_by_label::
...
const GRAMMAR_DIR: &str = concat!(env!("CARGO_MANIFEST_DIR"), "/tests/exclude_by_label");
