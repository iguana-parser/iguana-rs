...
pub enum E<'a> {
    ...
    Alt1 { e: &'a E<'a>, lit_1: Token, span: Span },
    //"-" E(3) return 3
    Alt2 { lit_0: Token, e: &'a E<'a>, span: Span },
    //[2 >= p] l=E(p) [l == 0 || l >= 2] "*" E(2) return 2
    Alt3 { e_0: &'a E<'a>, lit_1: Token, e_2: &'a E<'a>, span: Span },
    //[1 >= p] l=E(p) [l == 0 || l >= 1] "+" E(1) return 1
    Alt4 { e_0: &'a E<'a>, lit_1: Token, e_2: &'a E<'a>, span: Span },
    Amb(&'a [&'a E<'a>]),
}
impl<'a> S<'a> {
