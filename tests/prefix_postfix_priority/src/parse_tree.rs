...
pub struct PrefixPostfixPriorityParseTreeBuilder;
impl ParseTreeBuilder<ParseTree> for PrefixPostfixPriorityParseTreeBuilder {
...
pub fn create_parse_tree(
    ...
    builder: &PrefixPostfixPriorityParseTreeBuilder,
) -> ParseTree {
    match name {
