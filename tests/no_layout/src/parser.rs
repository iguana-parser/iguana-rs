...
use crate::{scanner::NoLayoutScanner, types::{EbnfKind, Nonterminal, Slot, Terminal}};
use iguana_runtime::{
        ...
        match slot_id {
            ...
            SlotId(5) => {
                ...
                match self.scanner.match_token(TerminalId(0), i) {
                    ...
                    None => {
                        record!(
                            self, MatchFailed, "Char", i, SlotId(5), gss_node_id, result
                        );
                    }
                }
            }
            ...
            SlotId(7) => {
                ...
                match self.scanner.match_token(TerminalId(0), i) {
                    ...
                    None => {
                        record!(
                            self, MatchFailed, "Char", i, SlotId(7), gss_node_id, result
                        );
                    }
                }
            }
            ...
            SlotId(9) => {
                ...
                match self.scanner.match_token(TerminalId(1), i) {
                    ...
                    None => {
                        record!(
                            self, MatchFailed, "WS", i, SlotId(9), gss_node_id, result
                        );
                    }
                }
            }
            ...
            SlotId(11) => {
                ...
                match self.scanner.match_token(TerminalId(1), i) {
                    ...
                    None => {
                        record!(
                            self, MatchFailed, "WS", i, SlotId(11), gss_node_id, result
                        );
                    }
                }
            }
