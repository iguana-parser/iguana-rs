...
impl<'i> Parser<'i> for NoLayoutParser<'i> {
    ...
    fn execute(
        ...
        match slot_id {
            ...
            //Id : . Id_Plus_0
            SlotId(2) => {
                self.create_id_plus_0(result, gss_node_id, SlotId(3));
            }
            //Id : Id_Plus_0.
            SlotId(3) => {
                let Some(result) = result else {
            ...
            SlotId(4) => {
                self.create_id_plus_0(result, gss_node_id, SlotId(5));
            }
            //Id_Plus_0 : Id_Plus_0 . Char
            SlotId(5) => {
                let i = input_index;
                ...
                match self.scanner.match_token(TerminalId(0), i) {
                    ...
                    None => {
                        record!(self, MatchFailed, "Char", i, SlotId(5), gss_node_id, result);
                    }
                }
            }
            //Id_Plus_0 : Id_Plus_0 Char.
            ...
            SlotId(7) => {
                ...
                match self.scanner.match_token(TerminalId(0), i) {
                    ...
                    None => {
                        record!(self, MatchFailed, "Char", i, SlotId(7), gss_node_id, result);
                    }
                }
            }
            //Id_Plus_0 : Char.
            ...
            //StartS : Layout . start:S Layout
            SlotId(10) => {
                self.create_s(result, gss_node_id, SlotId(11));
            }
            //StartS : Layout start:S . Layout
            SlotId(11) => {
                let i = input_index;
            ...
            //StartId : Layout . start:Id Layout
            SlotId(14) => {
                self.create_id(result, gss_node_id, SlotId(15));
            }
            //StartId : Layout start:Id . Layout
            SlotId(15) => {
                let i = input_index;
...
pub struct NoLayoutParser<'i> {
    start_nonterminal: NonterminalId,
    scanner: NoLayoutScanner<'i>,
