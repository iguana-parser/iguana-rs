...
use no_layout::{
    ...
    parser::{NoLayoutParser, NONTERMINALS, SLOTS, TERMINALS},
};
...
fn main() -> Result<(), io::Error> {
    ...
    let start_nonterminal_id = NoLayoutParser::nonterminal_id(&start_nonterminal_name)
            ...
            match &error.kind {
                ParseErrorKind::UnexpectedToken { expected } => {
                    let names: Vec<_> = expected
                        .iter()
                        .map(|t| NoLayoutParser::terminal_name(*t))
                        .collect();
                    println!(
