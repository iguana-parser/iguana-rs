...
struct Cli {
    ...
    ext: Option<String>,
    #[doc = "Run the NoLayout parser in REPL mode"]
    ///
    ...
    if args.check_sexpr || args.regenerate_sexpr {
        ...
        let passed = cli::run_golden(
            ...
            |path| {
                ...
                let parse_tree_builder = NoLayoutParseTreeBuilder::new(&ctx);
                let mut parser = NoLayoutParser::new(&input, start_nonterminal_id);
