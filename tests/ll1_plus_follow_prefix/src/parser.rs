...
impl<'i, 'arena> Parser<'i, 'arena> for Ll1PlusFollowPrefixParser<'i, 'arena> {
    ...
    fn build_tree<'a>(&self, root: SPPFNodeId, tree_arena: &'a Arena) -> ParseTree<'a> {
        let builder = Ll1PlusFollowPrefixParseTreeBuilder::new(tree_arena);
...
impl<'i, 'arena> Ll1PlusFollowPrefixParser<'i, 'arena> {
    ...
    pub fn new(input: &'i Input, parser_arena: &'arena Arena) -> Self {
        ...
        Self {
            vec_arena,
            scanner: Ll1PlusFollowPrefixScanner::new(input, vec_arena),
