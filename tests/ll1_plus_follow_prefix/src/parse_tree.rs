...
use crate::{grammar, parser::Ll1PlusFollowPrefixParser};
use iguana_runtime::{
    arena::Arena,
...
impl<'a> Plus0<'a> {
    ...
    pub fn child(&self, index: usize) -> Option<ParseTree<'a>> {
        match self {
            Plus0::Alt0 { plus_0, lit_1, .. } => match index {
                0 => Some(ParseTree::Plus0(plus_0)),
                1 => Some(ParseTree::Token(*lit_1)),
                _ => None,
            },
            Plus0::Alt1 { lit_0, .. } => match index {
...
pub struct Ll1PlusFollowPrefixParseTreeBuilder<'a> {
    pub arena: &'a Arena,
}
impl<'a> Ll1PlusFollowPrefixParseTreeBuilder<'a> {
    pub fn new(tree_arena: &'a Arena) -> Self {
        Self { arena: tree_arena }
    }
}
impl<'a> ParseTreeBuilder<ParseTree<'a>> for Ll1PlusFollowPrefixParseTreeBuilder<'a> {
    fn new_nonterminal_node(
        ...
        match nonterminal_node.nonterminal_id {
            ...
            NonterminalId(0) => match nonterminal_node.return_slot {
                // S = "ab"+ "a" "b"
                SlotId(3) => {
                    let [plus_0, lit_1, lit_2] = children.into_array::<3usize>();
...
pub fn create_parse_tree<'a>(
    ...
    builder: &Ll1PlusFollowPrefixParseTreeBuilder<'a>,
) -> ParseTree<'a> {
