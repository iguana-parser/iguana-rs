...
impl<'i> Parser<'i> for AmbiguousExprParser<'i> {
...
pub struct AmbiguousExprParser<'i> {
    start_nonterminal: NonterminalId,
    scanner: AmbiguousExprScanner<'i>,
    ...
    intermediate_nodes_index: [InlineMap<Span, SPPFNodeId>; 60],
...
impl<'i> AmbiguousExprParser<'i> {
    pub fn new(input: &'i Input, start_nonterminal: NonterminalId) -> Self {
        init_logger();
        Self {
            start_nonterminal,
            scanner: AmbiguousExprScanner::new(input),
