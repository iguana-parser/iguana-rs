...
use crate::{grammar, parser::AmbiguousExprParser};
use iguana_runtime::{
    arena::Arena,
...
pub struct AmbiguousExprParseTreeBuilder<'a> {
    pub arena: &'a Arena,
}
impl<'a> AmbiguousExprParseTreeBuilder<'a> {
    pub fn new(tree_arena: &'a Arena) -> Self {
        Self { arena: tree_arena }
    }
}
impl<'a> ParseTreeBuilder<ParseTree<'a>> for AmbiguousExprParseTreeBuilder<'a> {
...
pub fn create_parse_tree<'a>(
    ...
    builder: &AmbiguousExprParseTreeBuilder<'a>,
) -> ParseTree<'a> {
