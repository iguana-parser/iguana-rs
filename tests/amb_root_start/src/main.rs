use amb_root_start::{
    ...
    parse_tree::{AmbRootStartParseTreeBuilder, create_parse_tree, to_json, to_sexpr_with},
    parser::AmbRootStartParser,
};
...
#[derive(ClapParser)]
#[command(about = "Parser for the AmbRootStart grammar")]
...
struct Cli {
    ...
    ext: Option<String>,
    ///Run the AmbRootStart parser in REPL mode
    ///
    ...
    if args.check_sexpr || args.regenerate_sexpr {
        ...
        let passed = cli::run_golden(
            ...
            |path| {
                ...
                let parse_tree_builder = AmbRootStartParseTreeBuilder::new(&tree_arena);
                let vec_arena = Bump::new();
                let mut parser = AmbRootStartParser::new(&input, start_nonterminal_id, &vec_arena);
        ...
        for entry in &entries {
            ...
            let report = cli::run_corpus(
                ...
                |path| {
                    ...
                    let mut parser =
                        AmbRootStartParser::new(&input, start_nonterminal_id, &vec_arena);
