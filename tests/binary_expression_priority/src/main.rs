use binary_expression_priority::{
    parse_tree::{BinaryExpressionPriorityParseTreeBuilder, create_parse_tree, to_json, to_sexpr},
    parser::{BinaryExpressionPriorityParser, NONTERMINALS, SLOTS, TERMINALS},
};
...
fn main() -> Result<(), io::Error> {
    ...
    let start_nonterminal_id = BinaryExpressionPriorityParser::nonterminal_id(
    ...
    let parse_tree_builder = BinaryExpressionPriorityParseTreeBuilder;
