...
pub struct BinaryExpressionPriorityParseTreeBuilder;
impl ParseTreeBuilder<ParseTree> for BinaryExpressionPriorityParseTreeBuilder {
...
pub fn create_parse_tree(
    ...
    builder: &BinaryExpressionPriorityParseTreeBuilder,
) -> ParseTree {
    match name {
