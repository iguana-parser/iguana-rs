...
impl<'i, 'arena> Parser<'i, 'arena> for AmbPlusParser<'i, 'arena> {
    ...
    fn build_tree<'a>(&self, root: SPPFNodeId, tree_arena: &'a Arena) -> ParseTree<'a> {
        let builder = AmbPlusParseTreeBuilder::new(tree_arena);
    ...
    fn execute(
        ...
        match slot_id {
            // S : . Star_0
            SlotId(0) => {
                self.create(NonterminalId(6), result, gss_node_id, SlotId(1), env);
            }
            // S : Star_0.
            SlotId(1) => {
            ...
            // A : . X
            SlotId(2) => {
                if let Some(right_child) = self.parse_x_ll1(input_index) {
            ...
            // A : . Y
            SlotId(4) => {
                if let Some(right_child) = self.parse_y_ll1(input_index) {
                    let j = self.sppf_node(right_child).right_extent();
                    // A : Y.
            ...
            // Plus_0 : . Plus_0 A
            SlotId(11) => {
                self.create(NonterminalId(4), result, gss_node_id, SlotId(12), env);
            }
            // Plus_0 : Plus_0 . A
            SlotId(12) => {
            ...
            SlotId(13) => {
                let nonterminal_node_id =
                    self.create_nonterminal_node(result, NonterminalId(4), SlotId(13), gss_node_id);
            ...
            // Opt_0 : . Plus_0
            SlotId(16) => {
                self.create(NonterminalId(4), result, gss_node_id, SlotId(17), env);
            }
            // Opt_0 : Plus_0.
            SlotId(17) => {
                let nonterminal_node_id =
            ...
            // Star_0 : . Opt_0
            SlotId(19) => {
                self.create(NonterminalId(5), result, gss_node_id, SlotId(20), env);
            }
            // Star_0 : Opt_0.
            SlotId(20) => {
                let nonterminal_node_id =
            ...
            // StartS : . start:S
            SlotId(21) => {
                self.create(NonterminalId(0), result, gss_node_id, SlotId(22), env);
            }
            // StartS : start:S.
            SlotId(22) => {
                let nonterminal_node_id =
            ...
            // StartA : . start:A
            SlotId(23) => {
                self.create(NonterminalId(1), result, gss_node_id, SlotId(24), env);
            }
            // StartA : start:A.
            SlotId(24) => {
                let nonterminal_node_id =
                    self.create_nonterminal_node(result, NonterminalId(8), SlotId(24), gss_node_id);
            ...
            SlotId(25) => {
                if let Some(right_child) = self.parse_x_ll1(input_index) {
                    ...
                    self.add_failure(input_index, SlotId(25), Some(gss_node_id), || {
                        GLLFailureKind::UnexpectedToken {
                            expected: FIRST_SET_X.terminals.to_vec(),
                        }
                    });
            ...
            SlotId(26) => {
                let nonterminal_node_id =
                    self.create_nonterminal_node(result, NonterminalId(9), SlotId(26), gss_node_id);
                self.pop(gss_node_id, SlotId(26), nonterminal_node_id, None);
            }
            // StartY : . start:Y
            SlotId(27) => {
                if let Some(right_child) = self.parse_y_ll1(input_index) {
                    ...
                    self.add_failure(input_index, SlotId(27), Some(gss_node_id), || {
                        GLLFailureKind::UnexpectedToken {
                            expected: FIRST_SET_Y.terminals.to_vec(),
                        }
                    });
    ...
    fn follow_set_check(&mut self, nonterminal_id: NonterminalId, input_index: u32) -> bool {
        match nonterminal_id {
            ...
            NonterminalId(2) => self.scanner.match_any(&FOLLOW_SET_X, input_index),
            NonterminalId(3) => self.scanner.match_any(&FOLLOW_SET_Y, input_index),
            NonterminalId(4) => self.scanner.match_any(&FOLLOW_SET_PLUS_0, input_index),
            NonterminalId(5) => self.scanner.match_any(&FOLLOW_SET_OPT_0, input_index),
            NonterminalId(6) => self.scanner.match_any(&FOLLOW_SET_STAR_0, input_index),
            NonterminalId(7) => self.scanner.match_any(&FOLLOW_SET_START_S, input_index),
            NonterminalId(8) => self.scanner.match_any(&FOLLOW_SET_START_A, input_index),
            NonterminalId(9) => self.scanner.match_any(&FOLLOW_SET_START_X, input_index),
            NonterminalId(10) => self.scanner.match_any(&FOLLOW_SET_START_Y, input_index),
            _ => true,
        }
    }
    fn follow_set_terminals(&self, nonterminal_id: NonterminalId) -> Vec<TerminalId> {
        match nonterminal_id {
            ...
            NonterminalId(2) => FOLLOW_SET_X.terminals.to_vec(),
            NonterminalId(3) => FOLLOW_SET_Y.terminals.to_vec(),
            NonterminalId(4) => FOLLOW_SET_PLUS_0.terminals.to_vec(),
            NonterminalId(5) => FOLLOW_SET_OPT_0.terminals.to_vec(),
            NonterminalId(6) => FOLLOW_SET_STAR_0.terminals.to_vec(),
            NonterminalId(7) => FOLLOW_SET_START_S.terminals.to_vec(),
            NonterminalId(8) => FOLLOW_SET_START_A.terminals.to_vec(),
            NonterminalId(9) => FOLLOW_SET_START_X.terminals.to_vec(),
            NonterminalId(10) => FOLLOW_SET_START_Y.terminals.to_vec(),
            _ => vec![],
        }
    }
...
pub struct AmbPlusParser<'i, 'arena> {
    ...
    intermediate_nodes_index: [InlineMap<'arena, Span, SPPFNodeId>; 29],
    ...
    terminal_nodes_index: [InlineMap<'arena, Span, SPPFNodeId>; 3],
...
impl<'i, 'arena> AmbPlusParser<'i, 'arena> {
    ...
    pub fn new(input: &'i Input, parser_arena: &'arena Arena) -> Self {
        ...
        Self {
            vec_arena,
            scanner: AmbPlusScanner::new(input, vec_arena),
    ...
    pub fn parse_x(
        self,
        tree_arena: &Arena,
    ) -> Result<ParseSuccess<&parse_tree::StartX<'_>>, ParseError> {
        Ok(self
            .parse(START_X, tree_arena)?
            .map(ParseTree::unwrap_start_x))
    }
    pub fn parse_y(
        self,
        tree_arena: &Arena,
    ) -> Result<ParseSuccess<&parse_tree::StartY<'_>>, ParseError> {
        Ok(self
            .parse(START_Y, tree_arena)?
            .map(ParseTree::unwrap_start_y))
    }
