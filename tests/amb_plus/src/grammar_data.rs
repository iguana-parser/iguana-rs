...
// X { "a", EOF }
pub static FOLLOW_SET_X: &[TerminalId] = &[TerminalId(0), TerminalId(2)];
// X { "a" }
pub static FIRST_SET_X: &[TerminalId] = &[TerminalId(0)];
// X : . "a" { "a" }
pub static FIRST_SET_X_ALT0: &[TerminalId] = &[TerminalId(0)];
// Y { "a", EOF }
pub static FOLLOW_SET_Y: &[TerminalId] = &[TerminalId(0), TerminalId(2)];
// Y { "a" }
pub static FIRST_SET_Y: &[TerminalId] = &[TerminalId(0)];
// Y : . "a" "a" { "a" }
pub static FIRST_SET_Y_ALT0: &[TerminalId] = &[TerminalId(0)];
// Plus_0 { "a", EOF }
