...
impl<'a> ParseTree<'a> {
    ...
    fn unwrap_start_y(self) -> &'a Start<&'a Y<'a>, ()> {
        match self {
...
pub fn create_parse_tree<'a>(
    ...
    match nonterminal_id {
        ...
        crate::grammar_data::START_Y => {
            ParseTree::StartY(create_parse_tree_start_y(root_id, parser, builder))
        }
        _ => panic!(),
    }
}
...
pub fn create_parse_tree_start_y<'a>(
    root_id: SPPFNodeId,
    parser: &AmbPlusParser,
    builder: &AmbPlusParseTreeBuilder<'a>,
) -> &'a Start<&'a Y<'a>, ()> {
