...
use group::{
    ...
    parser::GroupParser, types::{Nonterminal, Slot, Terminal},
};
...
fn main() -> Result<(), io::Error> {
    ...
    let start_nonterminal_id = GroupParser::nonterminal_id(&start_nonterminal_name)
            ...
            match &error.kind {
                ParseErrorKind::UnexpectedToken { expected } => {
                    let names: Vec<_> = expected
                        .iter()
                        .map(|t| GroupParser::terminal_name(*t))
                        .collect();
                    println!(
