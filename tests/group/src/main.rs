...
use group::{
    ...
    parse_tree::{GroupParseTreeBuilder, create_parse_tree, to_json, to_sexpr_with},
    parser::GroupParser,
};
...
#[derive(ClapParser)]
#[command(about = "Parser for the Group grammar")]
...
struct Cli {
    ...
    ext: Option<String>,
    ///Run the Group parser in REPL mode
    ///
    ...
    if args.check_sexpr || args.regenerate_sexpr {
        ...
        let passed = cli::run_golden(
            ...
            |path| {
                ...
                let mut parser = GroupParser::new(&input, start_nonterminal_id, &vec_arena);
