...
struct Cli {
    ...
    ext: Option<String>,
    #[doc = "Run the LeftRecursiveList parser in REPL mode"]
    ///
    ...
    if args.check_sexpr || args.regenerate_sexpr {
        ...
        let passed = cli::run_golden(
            ...
            |path| {
                ...
                let parse_tree_builder = LeftRecursiveListParseTreeBuilder::new(&ctx);
                let mut parser = LeftRecursiveListParser::new(&input, start_nonterminal_id);
