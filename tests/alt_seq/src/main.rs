use alt_seq::{
    ...
    parse_tree::{AltSeqParseTreeBuilder, create_parse_tree, to_json, to_sexpr_with},
    parser::AltSeqParser,
};
...
#[derive(ClapParser)]
#[command(about = "Parser for the AltSeq grammar")]
...
struct Cli {
    ...
    ext: Option<String>,
    ///Run the AltSeq parser in REPL mode
    ///
    ...
    if args.check_sexpr || args.regenerate_sexpr {
        ...
        let passed = cli::run_golden(
            ...
            |path| {
                ...
                let mut parser = AltSeqParser::new(&input, start_nonterminal_id, &vec_arena);
