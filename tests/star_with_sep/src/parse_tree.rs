        ...
        match nonterminal_node.nonterminal_id {
            ...
            NonterminalId(2) => {
                match nonterminal_node.return_slot {
                    //{A ","}+ : {A ","}+ Layout "," Layout A.
                    SlotId(9) => {
                        let [r#as, layout_1, lit_2, layout_3, a_4] =
            ...
            NonterminalId(4) => {
                match nonterminal_node.return_slot {
                    //{A ","}* : {A ","}+?.
                    SlotId(16) => {
                        let [s_opt_0] = <[ParseTree; 1usize]>::try_from(children).unwrap();
                        SStar0 {
...
pub fn create_parse_tree(
    ...
    match name {
        ...
        "S_Star_0" => ParseTree::SStar0(create_parse_tree_s_star_0(root_id, parser, builder)),
