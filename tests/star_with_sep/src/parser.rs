...
impl<'i> Parser<'i> for StarWithSepParser<'i> {
    ...
    fn execute(
        ...
        match slot_id {
            //S : . S_Star_0
            SlotId(0) => {
                self.create_s_star_0(result, gss_node_id, SlotId(1), env);
            }
            //S : S_Star_0.
            SlotId(1) => {
            ...
            //S_Opt_0 : . S_Plus_0
            SlotId(10) => {
                self.create_s_plus_0(result, gss_node_id, SlotId(11), env);
            }
            //S_Opt_0 : S_Plus_0.
            SlotId(11) => {
                let Some(result) = result else {
            ...
            //S_Star_0 : . S_Opt_0
            SlotId(13) => {
                self.create_s_opt_0(result, gss_node_id, SlotId(14), env);
            }
            //S_Star_0 : S_Opt_0.
            SlotId(14) => {
                let Some(result) = result else {
