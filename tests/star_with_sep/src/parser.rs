...
static NONTERMINAL_IDS: phf::Map<&'static str, NonterminalId> = phf_map! {
    ...
    "S_Opt_0" => NonterminalId(3), "S_Star_0" => NonterminalId(4), "StartS" =>
    NonterminalId(5), "StartA" => NonterminalId(6)
};
...
pub const SLOTS: [Slot; 25] = [
    ...
    Slot {
        display_name: "{A \",\"}+ : . {A \",\"}+ Layout \",\" Layout A",
    },
    Slot {
        display_name: "{A \",\"}+ : {A \",\"}+ . Layout \",\" Layout A",
    },
...
impl<'i> Parser<'i> for StarWithSepParser<'i> {
    ...
    fn execute(
        ...
        match slot_id {
            ...
            //S_Plus_0 : . A
            SlotId(10) => {
                self.create(NonterminalId(1), result, gss_node_id, SlotId(11));
            }
            //S_Plus_0 : A.
            SlotId(11) => {
                let Some(result) = result else {
            ...
            //S_Opt_0 : . S_Plus_0
            SlotId(12) => {
                self.create(NonterminalId(2), result, gss_node_id, SlotId(13));
            }
            //S_Opt_0 : S_Plus_0.
            SlotId(13) => {
                let Some(result) = result else {
            ...
            //StartS : Layout . S Layout
            SlotId(18) => {
                self.create(NonterminalId(0), result, gss_node_id, SlotId(19));
            }
            //StartS : Layout S . Layout
            SlotId(19) => {
                let i = input_index;
            ...
            //StartA : Layout . A Layout
            SlotId(22) => {
                self.create(NonterminalId(1), result, gss_node_id, SlotId(23));
            }
            //StartA : Layout A . Layout
            SlotId(23) => {
                let i = input_index;
...
pub struct StarWithSepParser<'i> {
    start_nonterminal: NonterminalId,
    scanner: StarWithSepScanner<'i>,
    ...
    intermediate_nodes_index: [InlineMap<Span, SPPFNodeId>; 25],
