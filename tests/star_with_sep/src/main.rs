...
struct Cli {
    ...
    ext: Option<String>,
    #[doc = "Run the StarWithSep parser in REPL mode"]
    ///
    ...
    if args.check_sexpr || args.regenerate_sexpr {
        ...
        let passed = cli::run_golden(
            ...
            |path| {
                ...
                let parse_tree_builder = StarWithSepParseTreeBuilder::new(&ctx);
                let mut parser = StarWithSepParser::new(&input, start_nonterminal_id);
