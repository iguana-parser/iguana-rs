...
use keyword_labels::{
    ...
    parse_tree::{KeywordLabelsParseTreeBuilder, create_parse_tree, to_json, to_sexpr_with},
    ...
    if args.check_sexpr || args.regenerate_sexpr {
        ...
        let passed = cli::run_golden(
            ...
            |path| {
                ...
                let parse_tree_builder = KeywordLabelsParseTreeBuilder::new(&tree_arena);
                let vec_arena = Arena::new();
                let mut parser = KeywordLabelsParser::new(&input, start_nonterminal_id, &vec_arena);
        ...
        for entry in &entries {
            ...
            let report = cli::run_corpus(
                ...
                |path| {
                    ...
                    let mut parser =
                        KeywordLabelsParser::new(&input, start_nonterminal_id, &vec_arena);
