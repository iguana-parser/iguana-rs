...
pub const SLOTS: [Slot; 35] = [
    ...
    Slot {
        display_name: "E : . [2 >= p] l=E(p) [l == 0 || l >= 2] Layout \"+\" Layout r=E(2) return r == 0 ? 2 : min(r, 2)",
    },
    Slot {
        display_name: "E : [2 >= p] . l=E(p) [l == 0 || l >= 2] Layout \"+\" Layout r=E(2) return r == 0 ? 2 : min(r, 2)",
    },
    ...
    Slot {
        display_name: "E : . \"if\" Layout E(0) Layout \"then\" Layout E(0) Layout \"else\" Layout E(1) return 1",
    },
    Slot {
        display_name: "E : \"if\" . Layout E(0) Layout \"then\" Layout E(0) Layout \"else\" Layout E(1) return 1",
    },
...
impl<'i> Parser<'i> for DeepPriorityParser<'i> {
    ...
    fn execute(
        ...
        match slot_id {
            ...
            //E(p: i32) : . [2 >= p] l=E(p) [l == 0 || l >= 2] Layout "+" Layout r=E(2) return r == 0 ? 2 : min(r, 2)
            SlotId(5) => {
            ...
            //E(p: i32) : [2 >= p] l=E(p) [l == 0 || l >= 2] Layout "+" Layout . r=E(2) return r == 0 ? 2 : min(r, 2)
            SlotId(11) => {
                self.create_e(result, gss_node_id, SlotId(12), env, Some("r"), 2);
            }
            //E(p: i32) : [2 >= p] l=E(p) [l == 0 || l >= 2] Layout "+" Layout r=E(2) . return r == 0 ? 2 : min(r, 2)
            SlotId(12) => {
            ...
            //E(p: i32) : . "if" Layout E(0) Layout "then" Layout E(0) Layout "else" Layout E(1) return 1
            SlotId(14) => {
                let i = input_index;
            ...
            //E(p: i32) : "if" Layout E(0) Layout "then" Layout E(0) Layout "else" Layout . E(1) return 1
            SlotId(24) => {
                self.create_e(result, gss_node_id, SlotId(25), env, None, 1);
            }
            //E(p: i32) : "if" Layout E(0) Layout "then" Layout E(0) Layout "else" Layout E(1) . return 1
            SlotId(25) => {
