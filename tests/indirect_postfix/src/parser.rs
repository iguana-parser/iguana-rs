...
// E(p: i32)
//   = "a" return 0
//   | [2 >= p] l=E(p) [(l == 0) || (l >= 2)] WS "+" WS E(2) return 2
//   | [1 >= p] l=Postfix(p) [(l == 0) || (l >= 1)] return 0
//
// Postfix(p: i32)
//   = r=Body(p) WS "!" return r
//
// Body(p: i32)
//   = r=E(p) return r
//
...
// "+" = +
// "!" = !
use crate::{grammar_data::*, scanner::IndirectPostfixScanner};
...
impl<'i> Parser<'i> for IndirectPostfixParser<'i> {
    ...
    fn execute(
        ...
        match slot_id {
            ...
            // E(p: i32) : [2 >= p] l=E(p) [(l == 0) || (l >= 2)] WS "+" WS . E(2) return 2
            SlotId(15) => {
                self.create_e(result, gss_node_id, SlotId(16), env, None, 2);
            }
            // E(p: i32) : [2 >= p] l=E(p) [(l == 0) || (l >= 2)] WS "+" WS E(2) . return 2
            SlotId(16) => {
            ...
            SlotId(27) => {
                ...
                let nonterminal_node_id = self.create_nonterminal_node_or_attach_children_postfix(
                    NonterminalId(3),
                    SlotId(27),
                    node.left_extent(),
                    node.right_extent(),
    ...
    fn add_start_gss_node(
        ...
        match nonterminal_id {
            ...
            NonterminalId(3) => self.add_gss_node_postfix(input_index, 0, gss_node_id),
    ...
    fn follow_set_check(&mut self, nonterminal_id: NonterminalId, input_index: u32) -> bool {
        match nonterminal_id {
            ...
            NonterminalId(3) => self.scanner.match_any(FOLLOW_SET_POSTFIX, input_index),
    ...
    fn follow_set_terminals(&self, nonterminal_id: NonterminalId) -> Vec<TerminalId> {
        match nonterminal_id {
            ...
            NonterminalId(2) => FOLLOW_SET_E.to_vec(),
            NonterminalId(3) => FOLLOW_SET_POSTFIX.to_vec(),
            NonterminalId(4) => FOLLOW_SET_BODY.to_vec(),
...
pub struct IndirectPostfixParser<'i> {
    start_nonterminal: NonterminalId,
    scanner: IndirectPostfixScanner<'i>,
    ...
    gss_nodes_index_postfix: InlineMap<(u32, i32), GssNodeId>,
    ...
    dd_intermediate_nodes_index: [InlineMap<(Span, Option<EnvId>), SPPFNodeId>; 25],
...
impl<'i> IndirectPostfixParser<'i> {
    pub fn new(input: &'i Input, start_nonterminal: NonterminalId) -> Self {
        init_logger();
        Self {
            start_nonterminal,
            scanner: IndirectPostfixScanner::new(input),
