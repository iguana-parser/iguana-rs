...
static DFA_3: Dfa = Dfa::new(&[
    State::new(&[(';', ';', 1), ('=', '=', 1)], None),
    State::new(&[(';', ';', 1), ('=', '=', 1)], Some(TerminalId(3))),
]);
pub struct ExceptFollowRestrictionScanner<'i, 'arena> {
    pub input: &'i Input,
    vec_arena: &'arena Arena,
    memo: MatchMemo<'arena, MATCH_MEMO_WORDS>,
    match_any_memo: MatchAnyMemo<'arena, MATCH_ANY_SET_WORDS>,
}
impl<'i, 'arena> ExceptFollowRestrictionScanner<'i, 'arena> {
...
impl Scanner for ExceptFollowRestrictionScanner<'_, '_> {
