...
use crate::{grammar, parser::ExceptFollowRestrictionParser};
use iguana_runtime::{
    arena::Arena,
...
pub struct ExceptFollowRestrictionParseTreeBuilder<'a> {
    pub arena: &'a Arena,
}
impl<'a> ExceptFollowRestrictionParseTreeBuilder<'a> {
    pub fn new(tree_arena: &'a Arena) -> Self {
        Self { arena: tree_arena }
    }
}
impl<'a> ParseTreeBuilder<ParseTree<'a>> for ExceptFollowRestrictionParseTreeBuilder<'a> {
...
pub fn create_parse_tree<'a>(
    root_id: SPPFNodeId,
    parser: &ExceptFollowRestrictionParser,
    builder: &ExceptFollowRestrictionParseTreeBuilder<'a>,
) -> ParseTree<'a> {
