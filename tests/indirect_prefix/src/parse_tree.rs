...
use crate::{grammar, parser::IndirectPrefixParser};
use iguana_runtime::{
    arena::Arena,
...
pub type StartLambda<'a> = Start<&'a Lambda<'a>, Token>;
...
impl<'a> ParseTree<'a> {
    ...
    pub(crate) fn unwrap_lambda(self) -> &'a Lambda<'a> {
        match self {
    ...
    pub(crate) fn unwrap_start_lambda(self) -> &'a Start<&'a Lambda<'a>, Token> {
        match self {
    ...
    fn new_nonterminal_node(
        ...
        match nonterminal_node.nonterminal_id {
            ...
            NonterminalId(3) => match nonterminal_node.return_slot {
                // StartLambda = WS start:Lambda WS
                SlotId(13) => {
                    let [ws_0, start, ws_2] = children.into_array::<3usize>();
...
pub fn create_parse_tree<'a>(
    ...
    match root.nonterminal_id {
        ...
        grammar::LAMBDA => ParseTree::Lambda(
        ...
        grammar::START_LAMBDA => ParseTree::StartLambda(
            visit_sppf(root_id, parser, builder)
                .unwrap_one()
                .unwrap_start_lambda(),
        ),
