...
pub fn parse_s<'a>(
    ...
    let mut parser = IndirectPrefixParser::new(input, grammar_data::START_S);
    match parser.run() {
...
pub fn parse_e<'a>(
    ...
    let mut parser = IndirectPrefixParser::new(input, grammar_data::E);
    match parser.run() {
        ParseResult::Success(success) => {
            let parse_duration = success.duration;
            let tree_start = iguana_runtime::Instant::now();
...
pub fn parse_lambda<'a>(
    ...
    let mut parser = IndirectPrefixParser::new(input, grammar_data::LAMBDA);
    match parser.run() {
        ParseResult::Success(success) => {
            let parse_duration = success.duration;
            let tree_start = iguana_runtime::Instant::now();
...
pub fn parse_body<'a>(
    ...
    let mut parser = IndirectPrefixParser::new(input, grammar_data::BODY);
    match parser.run() {
        ParseResult::Success(success) => {
            let parse_duration = success.duration;
            let tree_start = iguana_runtime::Instant::now();
