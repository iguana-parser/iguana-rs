...
impl<'i> Parser<'i> for ExceptRegexReferenceParser<'i> {
...
pub struct ExceptRegexReferenceParser<'i> {
    start_nonterminal: NonterminalId,
    scanner: ExceptRegexReferenceScanner<'i>,
...
impl<'i> ExceptRegexReferenceParser<'i> {
    pub fn new(input: &'i Input, start_nonterminal: NonterminalId) -> Self {
        init_logger();
        Self {
            start_nonterminal,
            scanner: ExceptRegexReferenceScanner::new(input),
