...
struct Cli {
    ...
    ext: Option<String>,
    #[doc = "Run the ExceptRegexReference parser in REPL mode"]
    ///
    ...
    if args.check_sexpr || args.regenerate_sexpr {
        ...
        let passed = cli::run_golden(
            ...
            |path| {
                ...
                let parse_tree_builder = ExceptRegexReferenceParseTreeBuilder::new(&ctx);
                let mut parser = ExceptRegexReferenceParser::new(&input, start_nonterminal_id);
