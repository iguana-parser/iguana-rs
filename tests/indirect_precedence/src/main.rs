...
use indirect_precedence::{
    parse_tree::{IndirectPrecedenceParseTreeBuilder, create_parse_tree, to_json, to_sexpr},
...
fn main() -> Result<(), io::Error> {
    ...
    let start_nonterminal_id = IndirectPrecedenceParser::nonterminal_id(&start_nonterminal_name)
        .ok_or_else(|| {
            io::Error::new(
                io::ErrorKind::InvalidInput,
    ...
    let parse_tree_builder = IndirectPrecedenceParseTreeBuilder;
