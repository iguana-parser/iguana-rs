...
struct Cli {
    ...
    ext: Option<String>,
    #[doc = "Run the IndirectPrecedence parser in REPL mode"]
    ///
    ...
    if args.check_sexpr || args.regenerate_sexpr {
        ...
        let passed = cli::run_golden(
            ...
            |path| {
                ...
                let parse_tree_builder = IndirectPrecedenceParseTreeBuilder::new(&ctx);
                let mut parser = IndirectPrecedenceParser::new(&input, start_nonterminal_id);
