...
impl<'i> Parser<'i> for IndirectPrecedenceParser<'i> {
    ...
    fn execute(
        ...
        match slot_id {
            ...
            SlotId(0) => {
                let i = input_index;
                if let Some(right_child_id) = self.parse_e_ll1(i) {
            ...
            SlotId(2) => {
                ...
                match self.scanner.match_token(TerminalId(0), i) {
                    ...
                    None => {
                        record!(
                            self, MatchFailed, "\"-\"", i, SlotId(2), gss_node_id, result
                        );
                    }
                }
            }
            ...
            SlotId(10) => {
                ...
                match self.scanner.match_token(TerminalId(4), i) {
                    ...
                    None => {
                        record!(
                            self, MatchFailed, "Layout", i, SlotId(10), gss_node_id,
                            result
                        );
                    }
                }
            ...
            SlotId(11) => {
                ...
                match self.scanner.match_token(TerminalId(1), i) {
                    ...
                    None => {
                        record!(
                            self, MatchFailed, "\"*\"", i, SlotId(11), gss_node_id,
                            result
                        );
                    }
                }
            ...
            SlotId(12) => {
                ...
                match self.scanner.match_token(TerminalId(4), i) {
                    ...
                    None => {
                        record!(
                            self, MatchFailed, "Layout", i, SlotId(12), gss_node_id,
                            result
                        );
                    }
                }
            ...
            SlotId(13) => {
                let i = input_index;
                if let Some(right_child_id) = self.parse_f_ll1(i) {
                    let j = self.sppf_node(right_child_id).right_extent();
                    //E(p: i32) : [1 >= p] l=E(p) [l == 0 || l >= 1] Layout "*" Layout F . return 0
            ...
            SlotId(16) => {
                ...
                match self.scanner.match_token(TerminalId(2), i) {
                    ...
                    None => {
                        record!(
                            self, MatchFailed, "\"a\"", i, SlotId(16), gss_node_id,
                            result
                        );
                    }
                }
            ...
            SlotId(21) => {
                ...
                match self.scanner.match_token(TerminalId(3), i) {
                    ...
                    None => {
                        record!(
                            self, MatchFailed, "\"/\"", i, SlotId(21), gss_node_id,
                            result
                        );
                    }
                }
            ...
            SlotId(23) => {
                let i = input_index;
                if let Some(right_child_id) = self.parse_k_ll1(i) {
                    let j = self.sppf_node(right_child_id).right_extent();
                    //F : E(0) Layout "/" Layout K.
            ...
            SlotId(33) => {
                ...
                match self.scanner.match_token(TerminalId(4), i) {
                    ...
                    None => {
                        record!(
                            self, MatchFailed, "Layout", i, SlotId(33), gss_node_id,
                            result
                        );
                    }
                }
...
impl<'i> IndirectPrecedenceParser<'i> {
    ...
    fn parse_k_ll1(&mut self, i: u32) -> Option<SPPFNodeId> {
        if self.scanner.match_token(TerminalId(2), i).is_some()
            || self.scanner.match_token(TerminalId(0), i).is_some()
        {
            let mut j = i;
    ...
    fn parse_start_e_ll1(&mut self, i: u32) -> Option<SPPFNodeId> {
        if self.scanner.match_token(TerminalId(2), i).is_some()
            || self.scanner.match_token(TerminalId(4), i).is_some()
            || self.scanner.match_token(TerminalId(0), i).is_some()
        {
    ...
    fn parse_start_f_ll1(&mut self, i: u32) -> Option<SPPFNodeId> {
        if self.scanner.match_token(TerminalId(2), i).is_some()
            || self.scanner.match_token(TerminalId(4), i).is_some()
            || self.scanner.match_token(TerminalId(0), i).is_some()
        {
    ...
    fn parse_start_k_ll1(&mut self, i: u32) -> Option<SPPFNodeId> {
        if self.scanner.match_token(TerminalId(2), i).is_some()
            || self.scanner.match_token(TerminalId(4), i).is_some()
            || self.scanner.match_token(TerminalId(0), i).is_some()
        {
