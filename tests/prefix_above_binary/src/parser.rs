...
impl<'i> Parser<'i> for PrefixAboveBinaryParser<'i> {
    ...
    fn execute(
        ...
        match slot_id {
            ...
            //E(p: i32) : "-" Layout . E(2) return 2
            SlotId(7) => {
                self.create_e(result, gss_node_id, SlotId(8), env, None, 2);
            }
            //E(p: i32) : "-" Layout E(2) . return 2
            SlotId(8) => {
            ...
            //StartS : Layout . start:S Layout
            SlotId(20) => {
                self.create_s(result, gss_node_id, SlotId(21));
            }
            //StartS : Layout start:S . Layout
            SlotId(21) => {
                let i = input_index;
            ...
            //StartE : Layout . start:E(0) Layout
            SlotId(24) => {
                self.create_e(result, gss_node_id, SlotId(25), env, None, 0);
            }
            //StartE : Layout start:E(0) . Layout
            SlotId(25) => {
                let i = input_index;
...
pub struct PrefixAboveBinaryParser<'i> {
    start_nonterminal: NonterminalId,
    scanner: PrefixAboveBinaryScanner<'i>,
...
impl<'i> PrefixAboveBinaryParser<'i> {
