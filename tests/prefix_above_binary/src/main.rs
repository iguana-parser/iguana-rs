...
use prefix_above_binary::{
    ...
    parser::{PrefixAboveBinaryParser, NONTERMINALS, SLOTS, TERMINALS},
};
...
fn main() -> Result<(), io::Error> {
    ...
    let start_nonterminal_id = PrefixAboveBinaryParser::nonterminal_id(
            ...
            match &error.kind {
                ParseErrorKind::UnexpectedToken { expected } => {
                    let names: Vec<_> = expected
                        .iter()
                        .map(|t| PrefixAboveBinaryParser::terminal_name(*t))
                        .collect();
                    println!(
