...
// To update golden files: REGENERATE=1 cargo test -p iguana-tests --test grammar_tests prefix_above_binary::
...
const GRAMMAR_DIR: &str = concat!(env!("CARGO_MANIFEST_DIR"), "/tests/prefix_above_binary");
