...
use dangling_else::{
    ...
    parse_tree::{DanglingElseParseTreeBuilder, create_parse_tree, to_json, to_sexpr_with},
    ...
    if args.check_sexpr || args.regenerate_sexpr {
        ...
        let passed = cli::run_golden(
            ...
            |path| {
                ...
                let mut parser = DanglingElseParser::new(&input, start_nonterminal_id, &vec_arena);
        ...
        for entry in &entries {
            ...
            let report = cli::run_corpus(
                ...
                |path| {
                    ...
                    let mut parser =
                        DanglingElseParser::new(&input, start_nonterminal_id, &vec_arena);
