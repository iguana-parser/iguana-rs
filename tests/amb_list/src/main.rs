...
struct Cli {
    ...
    ext: Option<String>,
    #[doc = "Run the AmbList parser in REPL mode"]
    ///
    ...
    if args.check_sexpr || args.regenerate_sexpr {
        ...
        let passed = cli::run_golden(
            ...
            |path| {
                ...
                let parse_tree_builder = AmbListParseTreeBuilder::new(&ctx);
                let mut parser = AmbListParser::new(&input, start_nonterminal_id);
