...
use follow_restriction::{
    ...
    parser::FollowRestrictionParser, types::{Nonterminal, Slot, Terminal},
};
...
fn main() -> Result<(), io::Error> {
    ...
    let start_nonterminal_id = FollowRestrictionParser::nonterminal_id(
            ...
            match &error.kind {
                ParseErrorKind::UnexpectedToken { expected } => {
                    let names: Vec<_> = expected
                        .iter()
                        .map(|t| FollowRestrictionParser::terminal_name(*t))
                        .collect();
                    println!(
