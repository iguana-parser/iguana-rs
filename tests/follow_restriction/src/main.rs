...
use follow_restriction::{
    parse_tree::{FollowRestrictionParseTreeBuilder, create_parse_tree, to_json, to_sexpr},
    parser::{FollowRestrictionParser, NONTERMINALS, SLOTS, TERMINALS},
};
...
fn main() -> Result<(), io::Error> {
    ...
    let start_nonterminal_id = FollowRestrictionParser::nonterminal_id(&start_nonterminal_name)
        .ok_or_else(|| {
            io::Error::new(
                io::ErrorKind::InvalidInput,
