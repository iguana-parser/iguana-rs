...
static NONTERMINAL_IDS: phf::Map<&'static str, NonterminalId> = phf_map! {
    "S" => NonterminalId(0), "Id" => NonterminalId(1), "StartS" => NonterminalId(2),
    "StartId" => NonterminalId(3)
};
...
impl<'i> Parser<'i> for FollowRestrictionParser<'i> {
    ...
    fn execute(
        ...
        match slot_id {
            ...
            //StartS : Layout . start:S Layout
            SlotId(5) => {
                self.create_s(result, gss_node_id, SlotId(6));
            }
            //StartS : Layout start:S . Layout
            SlotId(6) => {
                let i = input_index;
            ...
            //StartId : Layout . start:Id Layout
            SlotId(9) => {
                self.create_id(result, gss_node_id, SlotId(10));
            }
            //StartId : Layout start:Id . Layout
            SlotId(10) => {
                let i = input_index;
