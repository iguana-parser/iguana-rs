...
impl<'i> Parser<'i> for FollowRestrictionLexicalMultipleParser<'i> {
...
pub struct FollowRestrictionLexicalMultipleParser<'i> {
    start_nonterminal: NonterminalId,
    scanner: FollowRestrictionLexicalMultipleScanner<'i>,
...
impl<'i> FollowRestrictionLexicalMultipleParser<'i> {
    pub fn new(input: &'i Input, start_nonterminal: NonterminalId) -> Self {
        init_logger();
        Self {
            start_nonterminal,
            scanner: FollowRestrictionLexicalMultipleScanner::new(input),
    ...
    fn parse_s_ll1(&mut self, i: u32) -> Option<SPPFNodeId> {
        ...
        match matched {
            TerminalId(2) | TerminalId(0) | TerminalId(3) => {
                let mut j = i;
                let right_child = {
                    let start = j;
