...
pub struct FollowRestrictionLexicalMultipleScanner<'i> {
    pub input: &'i Input,
    memo: MatchMemo<MATCH_MEMO_WORDS>,
    match_any_memo: MatchAnyMemo<MATCH_ANY_SET_WORDS>,
}
impl<'i> FollowRestrictionLexicalMultipleScanner<'i> {
    ...
    pub fn match_terminal_0(&self, input_index: u32) -> Option<u32> {
        self.scan(&DFA_0, input_index)
            ...
            .and_then(|end| {
                if self.match_terminal_2(end).is_some() {
                    None
                } else {
                    Some(end)
                }
...
impl Scanner for FollowRestrictionLexicalMultipleScanner<'_> {
