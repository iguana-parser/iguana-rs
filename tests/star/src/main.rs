...
use star::{
    ...
    parser::{StarParser, NONTERMINALS, SLOTS, TERMINALS},
};
...
fn main() -> Result<(), io::Error> {
    ...
    let start_nonterminal_id = StarParser::nonterminal_id(&start_nonterminal_name)
            ...
            match &error.kind {
                ParseErrorKind::UnexpectedToken { expected } => {
                    let names: Vec<_> = expected
                        .iter()
                        .map(|t| StarParser::terminal_name(*t))
                        .collect();
                    println!(
