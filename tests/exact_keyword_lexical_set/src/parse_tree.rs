...
use crate::{grammar, parser::ExactKeywordLexicalSetParser};
use iguana_runtime::{
    arena::Arena,
...
pub struct ExactKeywordLexicalSetParseTreeBuilder<'a> {
    pub arena: &'a Arena,
}
impl<'a> ExactKeywordLexicalSetParseTreeBuilder<'a> {
    pub fn new(tree_arena: &'a Arena) -> Self {
        Self { arena: tree_arena }
    }
}
impl<'a> ParseTreeBuilder<ParseTree<'a>> for ExactKeywordLexicalSetParseTreeBuilder<'a> {
...
pub fn create_parse_tree<'a>(
    root_id: SPPFNodeId,
    parser: &ExactKeywordLexicalSetParser,
    builder: &ExactKeywordLexicalSetParseTreeBuilder<'a>,
) -> ParseTree<'a> {
