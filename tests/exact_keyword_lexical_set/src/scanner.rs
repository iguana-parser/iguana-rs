...
static DFA_1: Dfa = Dfa::new(&[
    ...
    State::new(&[('a', 'a', 4), ('b', 'z', 1)], Some(TerminalId(1))),
    State::new(
        &[('a', 'q', 1), ('r', 'r', 5), ('s', 'z', 1)],
        Some(TerminalId(1)),
    ),
    ...
    State::new_excluded(&[('a', 'z', 1)], Some(TerminalId(1))),
    State::new_excluded(&[('a', 'z', 1)], Some(TerminalId(1))),
]);
...
impl Scanner for ExactKeywordLexicalSetScanner<'_, '_> {
