...
impl<'i> Parser<'i> for PlusExceptParser<'i> {
...
pub struct PlusExceptParser<'i> {
    start_nonterminal: NonterminalId,
    scanner: PlusExceptScanner<'i>,
    ...
    intermediate_nodes_index: [InlineMap<Span, SPPFNodeId>; 16],
