...
struct Cli {
    ...
    ext: Option<String>,
    #[doc = "Run the TokenOnlyUnsafe parser in REPL mode"]
    ///
    ...
    if args.check_sexpr || args.regenerate_sexpr {
        ...
        let passed = cli::run_golden(
            ...
            |path| {
                ...
                let parse_tree_builder = TokenOnlyUnsafeParseTreeBuilder::new(&ctx);
                let mut parser = TokenOnlyUnsafeParser::new(&input, start_nonterminal_id);
