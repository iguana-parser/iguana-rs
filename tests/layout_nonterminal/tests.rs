...
// To update golden files: REGENERATE=1 cargo test -p iguana-tests --test grammar_tests layout_nonterminal::

use iguana_runtime::input::Input;
use iguana_runtime::parse_tree::ParseContext;
use iguana_runtime::testing::{check_golden_file, golden_path};
use layout_nonterminal::{parse_s, parse_tree::to_sexpr};
const GRAMMAR_DIR: &str = concat!(env!("CARGO_MANIFEST_DIR"), "/tests/layout_nonterminal");
