...
static DFA_2: Dfa = Dfa::new(&[
    State::new(&[('0', '9', 1)], None),
    State::new(&[('0', '9', 1)], Some(TerminalId(2))),
]);
...
static DFA_4: Dfa = Dfa::new(&[
    State::new(&[(';', ';', 1), ('=', '=', 1)], None),
    State::new(&[(';', ';', 1), ('=', '=', 1)], Some(TerminalId(4))),
]);
pub struct PrecedeFollowRestrictionScanner<'i, 'arena> {
    pub input: &'i Input,
    vec_arena: &'arena Arena,
    memo: MatchMemo<'arena, MATCH_MEMO_WORDS>,
    match_any_memo: MatchAnyMemo<'arena, MATCH_ANY_SET_WORDS>,
}
impl<'i, 'arena> PrecedeFollowRestrictionScanner<'i, 'arena> {
...
impl Scanner for PrecedeFollowRestrictionScanner<'_, '_> {
