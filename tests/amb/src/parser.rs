...
use crate::{grammar_data::*, scanner::AmbScanner};
...
impl<'i, 'arena> Parser<'i, 'arena> for AmbParser<'i, 'arena> {
    ...
    fn execute(
        ...
        match slot_id {
            ...
            // E(p: i32) : . [2 >= p] l=lhs:E(p) [(l == 0) || (l >= 2)] "*" rhs:E(3) return 2
            SlotId(9) => {
            ...
            // E(p: i32) : [2 >= p] l=lhs:E(p) [(l == 0) || (l >= 2)] "*" . rhs:E(3) return 2
            SlotId(13) => {
                self.create_e(result, gss_node_id, SlotId(14), env, None, 3);
            }
            // E(p: i32) : [2 >= p] l=lhs:E(p) [(l == 0) || (l >= 2)] "*" rhs:E(3) . return 2
            SlotId(14) => {
            ...
            // E(p: i32) : . [1 >= p] l=lhs:E(p) [(l == 0) || (l >= 1)] "+" rhs:E(2) return 1
            SlotId(16) => {
