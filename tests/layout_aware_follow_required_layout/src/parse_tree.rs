...
use crate::{grammar, parser::LayoutAwareFollowRequiredLayoutParser};
use iguana_runtime::{
    arena::Arena,
...
pub struct LayoutAwareFollowRequiredLayoutParseTreeBuilder<'a> {
    pub arena: &'a Arena,
}
impl<'a> LayoutAwareFollowRequiredLayoutParseTreeBuilder<'a> {
    pub fn new(tree_arena: &'a Arena) -> Self {
        Self { arena: tree_arena }
    }
}
impl<'a> ParseTreeBuilder<ParseTree<'a>> for LayoutAwareFollowRequiredLayoutParseTreeBuilder<'a> {
...
pub fn create_parse_tree<'a>(
    root_id: SPPFNodeId,
    parser: &LayoutAwareFollowRequiredLayoutParser,
    builder: &LayoutAwareFollowRequiredLayoutParseTreeBuilder<'a>,
) -> ParseTree<'a> {
