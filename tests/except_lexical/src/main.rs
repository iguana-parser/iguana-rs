...
use except_lexical::{
    ...
    parser::{ExceptLexicalParser, NONTERMINALS, SLOTS, TERMINALS},
};
...
fn main() -> Result<(), io::Error> {
    ...
    let start_nonterminal_id = ExceptLexicalParser::nonterminal_id(&start_nonterminal_name)
        .ok_or_else(|| {
            io::Error::new(
                io::ErrorKind::InvalidInput,
    ...
    let parse_tree_builder = ExceptLexicalParseTreeBuilder;
