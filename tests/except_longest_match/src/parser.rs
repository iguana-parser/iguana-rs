...
impl<'i> Parser<'i> for ExceptLongestMatchParser<'i> {
...
pub struct ExceptLongestMatchParser<'i> {
    start_nonterminal: NonterminalId,
    scanner: ExceptLongestMatchScanner<'i>,
    ...
    intermediate_nodes_index: [InlineMap<Span, SPPFNodeId>; 3],
...
impl<'i> ExceptLongestMatchParser<'i> {
    pub fn new(input: &'i Input, start_nonterminal: NonterminalId) -> Self {
        init_logger();
        Self {
            start_nonterminal,
            scanner: ExceptLongestMatchScanner::new(input),
            ...
            intermediate_nodes_index: [const { InlineMap::Empty }; 3],
