...
use crate::{grammar, parser::ExceptLongestMatchParser};
use iguana_runtime::{
    arena::Arena,
...
pub struct ExceptLongestMatchParseTreeBuilder<'a> {
    pub arena: &'a Arena,
}
impl<'a> ExceptLongestMatchParseTreeBuilder<'a> {
    pub fn new(tree_arena: &'a Arena) -> Self {
        Self { arena: tree_arena }
    }
}
impl<'a> ParseTreeBuilder<ParseTree<'a>> for ExceptLongestMatchParseTreeBuilder<'a> {
...
pub fn create_parse_tree<'a>(
    ...
    builder: &ExceptLongestMatchParseTreeBuilder<'a>,
) -> ParseTree<'a> {
