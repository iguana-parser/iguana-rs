...
impl<'i> Parser<'i> for OptParser<'i> {
    ...
    fn execute(
        ...
        match slot_id {
            //S : . S_Opt_0
            SlotId(0) => {
                self.create_s_opt_0(result, gss_node_id, SlotId(1));
            }
            //S : S_Opt_0.
            SlotId(1) => {
            ...
            //S_Opt_0 : . A
            SlotId(4) => {
                self.create_a(result, gss_node_id, SlotId(5));
            }
            //S_Opt_0 : A.
            SlotId(5) => {
                let Some(result) = result else {
            ...
            //StartS : Layout . start:S Layout
            SlotId(8) => {
                self.create_s(result, gss_node_id, SlotId(9));
            }
            //StartS : Layout start:S . Layout
            SlotId(9) => {
                let i = input_index;
            ...
            //StartA : Layout . start:A Layout
            SlotId(12) => {
                self.create_a(result, gss_node_id, SlotId(13));
            }
            //StartA : Layout start:A . Layout
            SlotId(13) => {
                let i = input_index;
