...
// To update golden files: REGENERATE=1 cargo test -p iguana-tests --test grammar_tests regex_composition::
...
const GRAMMAR_DIR: &str = concat!(env!("CARGO_MANIFEST_DIR"), "/tests/regex_composition");
