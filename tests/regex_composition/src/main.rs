...
struct Cli {
    ...
    ext: Option<String>,
    #[doc = "Run the RegexComposition parser in REPL mode"]
    ///
    ...
    if args.check_sexpr || args.regenerate_sexpr {
        ...
        let passed = cli::run_golden(
            ...
            |path| {
                ...
                let parse_tree_builder = RegexCompositionParseTreeBuilder::new(&ctx);
                let mut parser = RegexCompositionParser::new(&input, start_nonterminal_id);
