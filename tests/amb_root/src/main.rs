use amb_root::{
    ...
    parse_tree::{AmbRootParseTreeBuilder, create_parse_tree, to_json, to_sexpr_with},
...
#[derive(ClapParser)]
#[command(about = "Parser for the AmbRoot grammar")]
...
struct Cli {
    ...
    ext: Option<String>,
    ///Run the AmbRoot parser in REPL mode
    ///
