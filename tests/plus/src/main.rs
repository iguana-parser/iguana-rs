...
use plus::{
    ...
    parser::PlusParser, types::{Nonterminal, Slot, Terminal},
};
...
fn main() -> Result<(), io::Error> {
    ...
    let start_nonterminal_id = PlusParser::nonterminal_id(&start_nonterminal_name)
            ...
            match &error.kind {
                ParseErrorKind::UnexpectedToken { expected } => {
                    let names: Vec<_> = expected
                        .iter()
                        .map(|t| PlusParser::terminal_name(*t))
                        .collect();
                    println!(
