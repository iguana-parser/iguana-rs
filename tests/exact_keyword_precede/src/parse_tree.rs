...
use crate::{grammar, parser::ExactKeywordPrecedeParser};
use iguana_runtime::{
    arena::Arena,
...
pub struct ExactKeywordPrecedeParseTreeBuilder<'a> {
    pub arena: &'a Arena,
}
impl<'a> ExactKeywordPrecedeParseTreeBuilder<'a> {
    pub fn new(tree_arena: &'a Arena) -> Self {
        Self { arena: tree_arena }
    }
}
impl<'a> ParseTreeBuilder<ParseTree<'a>> for ExactKeywordPrecedeParseTreeBuilder<'a> {
...
pub fn create_parse_tree<'a>(
    root_id: SPPFNodeId,
    parser: &ExactKeywordPrecedeParser,
    builder: &ExactKeywordPrecedeParseTreeBuilder<'a>,
) -> ParseTree<'a> {
