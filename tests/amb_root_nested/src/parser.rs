...
impl<'i, 'arena> Parser<'i, 'arena> for AmbRootNestedParser<'i, 'arena> {
    ...
    fn execute(
        ...
        match slot_id {
            ...
            SlotId(6) => {
                if let Some((_, right_child)) =
                    self.match_terminal(TerminalId(3), input_index, SlotId(6), Some(gss_node_id))
                {
                    if let Some((j, new_node)) =
            ...
            // E(p: i32) : "(" WS Type WS ")" WS . E(2) return 2
            SlotId(8) => {
                self.create_e(result, gss_node_id, SlotId(9), env, None, 2);
            }
            // E(p: i32) : "(" WS Type WS ")" WS E(2) . return 2
            SlotId(9) => {
            ...
            SlotId(11) => {
                if let Some((j, right_child)) =
                    self.match_terminal(TerminalId(4), input_index, SlotId(11), Some(gss_node_id))
                {
                    // E(p: i32) : "-" . WS E(2) return 2
            ...
            // E(p: i32) : "-" WS . E(2) return 2
            SlotId(13) => {
                self.create_e(result, gss_node_id, SlotId(14), env, None, 2);
            }
            // E(p: i32) : "-" WS E(2) . return 2
            SlotId(14) => {
            ...
            // E(p: i32) : [1 >= p] l=E(p) [(l == 0) || (l >= 1)] WS "-" WS . E(1) return 1
            SlotId(22) => {
                self.create_e(result, gss_node_id, SlotId(23), env, None, 1);
            }
            // E(p: i32) : [1 >= p] l=E(p) [(l == 0) || (l >= 1)] WS "-" WS E(1) . return 1
            SlotId(23) => {
            ...
            SlotId(28) => {
                if let Some((_, right_child)) =
                    self.match_terminal(TerminalId(1), input_index, SlotId(28), Some(gss_node_id))
                {
                    if let Some((j, new_node)) =
            ...
            SlotId(29) => {
                if let Some((_, right_child)) =
                    self.match_terminal(TerminalId(4), input_index, SlotId(29), Some(gss_node_id))
                {
                    if let Some((j, new_node)) =
            ...
            SlotId(30) => {
                if let Some((_, right_child)) =
                    self.match_terminal(TerminalId(1), input_index, SlotId(30), Some(gss_node_id))
                {
                    if let Some((j, new_node)) =
            ...
            // E(p: i32) : [1 >= p] l=E(p) [(l == 0) || (l >= 1)] WS "-" WS . E(1) return 1
            SlotId(31) => {
                self.create_e(result, gss_node_id, SlotId(32), env, None, 1);
            }
            // E(p: i32) : [1 >= p] l=E(p) [(l == 0) || (l >= 1)] WS "-" WS E(1) . return 1
            SlotId(32) => {
            ...
            SlotId(35) => {
                if let Some((_, right_child)) =
                    self.match_terminal(TerminalId(1), input_index, SlotId(35), Some(gss_node_id))
                {
                    if let Some((j, new_node)) =
            ...
            // E(p: i32) : "(" WS . E(0) WS ")" return 0
            SlotId(36) => {
                self.create_e(result, gss_node_id, SlotId(37), env, None, 0);
            }
            // E(p: i32) : "(" WS E(0) . WS ")" return 0
            SlotId(37) => {
                if let Some((_, right_child)) =
                    self.match_terminal(TerminalId(1), input_index, SlotId(37), Some(gss_node_id))
                {
                    if let Some((j, new_node)) =
            ...
            SlotId(38) => {
                if let Some((_, right_child)) =
                    self.match_terminal(TerminalId(3), input_index, SlotId(38), Some(gss_node_id))
                {
                    if let Some((j, new_node)) =
