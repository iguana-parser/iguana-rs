...
impl<'i, 'arena> Parser<'i, 'arena> for FollowRestrictionMultipleParser<'i, 'arena> {
    ...
    fn new(input: &'i Input, parser_arena: &'arena Arena) -> Self {
        FollowRestrictionMultipleParser::new(input, parser_arena)
    }
...
pub struct FollowRestrictionMultipleParser<'i, 'arena> {
    // Arena backing the parser's internal collections; reset in bulk after the parse.
    vec_arena: &'arena Arena,
    scanner: FollowRestrictionMultipleScanner<'i, 'arena>,
...
impl<'i, 'arena> FollowRestrictionMultipleParser<'i, 'arena> {
