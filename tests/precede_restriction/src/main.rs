...
use precede_restriction::{
    ...
    parser::{PrecedeRestrictionParser, NONTERMINALS, SLOTS, TERMINALS},
};
...
fn main() -> Result<(), io::Error> {
    ...
    let start_nonterminal_id = PrecedeRestrictionParser::nonterminal_id(
            ...
            match &error.kind {
                ParseErrorKind::UnexpectedToken { expected } => {
                    let names: Vec<_> = expected
                        .iter()
                        .map(|t| PrecedeRestrictionParser::terminal_name(*t))
                        .collect();
                    println!(
