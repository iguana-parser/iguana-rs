...
impl<'i, 'arena> Parser<'i, 'arena> for Ll1PrefixConflictParser<'i, 'arena> {
    ...
    fn build_tree<'a>(&self, root: SPPFNodeId, tree_arena: &'a Arena) -> ParseTree<'a> {
        let builder = Ll1PrefixConflictParseTreeBuilder::new(tree_arena);
    ...
    fn follow_set_check(&mut self, nonterminal_id: NonterminalId, input_index: u32) -> bool {
        match nonterminal_id {
            ...
            NonterminalId(1) => self.scanner.match_any(&FOLLOW_SET_S, input_index),
            NonterminalId(2) => self.scanner.match_any(&FOLLOW_SET_START_T, input_index),
    ...
    fn follow_set_terminals(&self, nonterminal_id: NonterminalId) -> Vec<TerminalId> {
        match nonterminal_id {
            ...
            NonterminalId(1) => FOLLOW_SET_S.terminals.to_vec(),
            NonterminalId(2) => FOLLOW_SET_START_T.terminals.to_vec(),
...
impl<'i, 'arena> Ll1PrefixConflictParser<'i, 'arena> {
    ...
    pub fn new(input: &'i Input, parser_arena: &'arena Arena) -> Self {
        ...
        Self {
            vec_arena,
            scanner: Ll1PrefixConflictScanner::new(input, vec_arena),
