...
pub enum SPlus0<'a> {
    //Element+ WS Element
    Alt0 { elements: &'a SPlus0<'a>, ws: Token, element_2: &'a Element<'a>, span: Span },
    //Element
    Alt1 { element: &'a Element<'a>, span: Span },
    Amb(&'a [&'a SPlus0<'a>]),
}
impl<'a> S<'a> {
...
impl<'a> ParseTreeBuilder<ParseTree<'a>>
for FollowRestrictionLexicalParseTreeBuilder<'a> {
