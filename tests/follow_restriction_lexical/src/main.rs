...
use follow_restriction_lexical::{
    parse_tree::{FollowRestrictionLexicalParseTreeBuilder, create_parse_tree, to_json, to_sexpr},
    parser::{FollowRestrictionLexicalParser, NONTERMINALS, SLOTS, TERMINALS},
};
...
fn main() -> Result<(), io::Error> {
    ...
    let start_nonterminal_id = FollowRestrictionLexicalParser::nonterminal_id(
    ...
    let parse_tree_builder = FollowRestrictionLexicalParseTreeBuilder;
