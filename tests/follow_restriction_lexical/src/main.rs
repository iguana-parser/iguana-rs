...
use follow_restriction_lexical::{
    grammar_data::{NONTERMINAL_DISPLAY_ORDER, NONTERMINALS, SLOTS, TERMINALS, nonterminal_id},
    parse_tree::{
        FollowRestrictionLexicalParseTreeBuilder, create_parse_tree, to_json, to_sexpr_with,
    },
...
#[derive(ClapParser)]
#[command(about = "Parser for the FollowRestrictionLexical grammar")]
...
struct Cli {
    ...
    ext: Option<String>,
    #[doc = "Run the FollowRestrictionLexical parser in REPL mode"]
    ///
    ...
    if args.check_sexpr || args.regenerate_sexpr {
        ...
        let passed = cli::run_golden(
            ...
            |path| {
                ...
                let parse_tree_builder = FollowRestrictionLexicalParseTreeBuilder::new(&ctx);
                let mut parser = FollowRestrictionLexicalParser::new(&input, start_nonterminal_id);
        ...
        for entry in &entries {
            ...
            let report = cli::run_corpus(
                ...
                |path| {
                    ...
                    let mut parser =
                        FollowRestrictionLexicalParser::new(&input, start_nonterminal_id);
