...
struct Cli {
    ...
    ext: Option<String>,
    #[doc = "Run the LongestMatch parser in REPL mode"]
    ///
    ...
    if args.check_sexpr || args.regenerate_sexpr {
        ...
        let passed = cli::run_golden(
            ...
            |path| {
                ...
                let parse_tree_builder = LongestMatchParseTreeBuilder::new(&ctx);
                let mut parser = LongestMatchParser::new(&input, start_nonterminal_id);
