...
impl<'i> Parser<'i> for LongestMatchParser<'i> {
    ...
    fn follow_set_terminals(&self, nonterminal_id: NonterminalId) -> Vec<TerminalId> {
        match nonterminal_id {
            ...
            NonterminalId(1) => FOLLOW_SET_X.to_vec(),
            _ => vec![],
        }
    }
...
pub struct LongestMatchParser<'i> {
    start_nonterminal: NonterminalId,
    scanner: LongestMatchScanner<'i>,
...
impl<'i> LongestMatchParser<'i> {
    pub fn new(input: &'i Input, start_nonterminal: NonterminalId) -> Self {
        init_logger();
        Self {
            start_nonterminal,
            scanner: LongestMatchScanner::new(input),
