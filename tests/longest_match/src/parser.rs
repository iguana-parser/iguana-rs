...
impl<'i, 'arena> Parser<'i, 'arena> for LongestMatchParser<'i, 'arena> {
    ...
    fn build_tree<'a>(&self, root: SPPFNodeId, tree_arena: &'a Arena) -> ParseTree<'a> {
        let builder = LongestMatchParseTreeBuilder::new(tree_arena);
...
impl<'i, 'arena> LongestMatchParser<'i, 'arena> {
    ...
    pub fn new(input: &'i Input, parser_arena: &'arena Arena) -> Self {
        ...
        Self {
            vec_arena,
            scanner: LongestMatchScanner::new(input, vec_arena),
