...
use comments::{
    ...
    parse_tree::{CommentsParseTreeBuilder, create_parse_tree, to_json, to_sexpr_with},
...
#[derive(ClapParser)]
#[command(about = "Parser for the Comments grammar")]
...
struct Cli {
    ...
    ext: Option<String>,
    ///Run the Comments parser in REPL mode
    ///
    ...
    if args.check_sexpr || args.regenerate_sexpr {
        ...
        let passed = cli::run_golden(
            ...
            |path| {
                ...
                let mut parser = CommentsParser::new(&input, start_nonterminal_id, &vec_arena);
