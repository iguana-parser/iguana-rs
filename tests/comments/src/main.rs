...
use comments::{
    ...
    parser::CommentsParser, types::{Nonterminal, Slot, Terminal},
};
...
fn main() -> Result<(), io::Error> {
    ...
    let start_nonterminal_id = CommentsParser::nonterminal_id(&start_nonterminal_name)
    ...
    if let Some(iterations) = cli.profile {
        let parse_tree_builder = CommentsParseTreeBuilder;
