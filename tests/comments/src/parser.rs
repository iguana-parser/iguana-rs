...
impl<'i, 'arena> Parser<'i, 'arena> for CommentsParser<'i, 'arena> {
    ...
    fn build_tree<'a>(&self, root: SPPFNodeId, tree_arena: &'a Arena) -> ParseTree<'a> {
        let builder = CommentsParseTreeBuilder::new(tree_arena);
...
impl<'i, 'arena> CommentsParser<'i, 'arena> {
    ...
    pub fn new(input: &'i Input, parser_arena: &'arena Arena) -> Self {
        ...
        Self {
            vec_arena,
            scanner: CommentsScanner::new(input, vec_arena),
