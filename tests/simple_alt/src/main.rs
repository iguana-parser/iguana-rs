...
use simple_alt::{
    ...
    parse_tree::{SimpleAltParseTreeBuilder, create_parse_tree, to_json, to_sexpr_with},
...
#[derive(ClapParser)]
#[command(about = "Parser for the SimpleAlt grammar")]
...
struct Cli {
    ...
    ext: Option<String>,
    ///Run the SimpleAlt parser in REPL mode
    ///
    ...
    if args.check_sexpr || args.regenerate_sexpr {
        ...
        let passed = cli::run_golden(
            ...
            |path| {
                ...
                let mut parser = SimpleAltParser::new(&input, start_nonterminal_id, &vec_arena);
