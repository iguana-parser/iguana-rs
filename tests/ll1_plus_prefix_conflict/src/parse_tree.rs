...
use crate::{grammar, parser::Ll1PlusPrefixConflictParser};
use iguana_runtime::{
    arena::Arena,
...
impl<'a> S<'a> {
    ...
    pub fn child(&self, index: usize) -> Option<ParseTree<'a>> {
        match self {
            S::Alt0 { plus_0, lit_1, .. } => match index {
...
pub struct Ll1PlusPrefixConflictParseTreeBuilder<'a> {
    pub arena: &'a Arena,
}
impl<'a> Ll1PlusPrefixConflictParseTreeBuilder<'a> {
    pub fn new(tree_arena: &'a Arena) -> Self {
        Self { arena: tree_arena }
    }
}
impl<'a> ParseTreeBuilder<ParseTree<'a>> for Ll1PlusPrefixConflictParseTreeBuilder<'a> {
...
pub fn create_parse_tree<'a>(
    ...
    builder: &Ll1PlusPrefixConflictParseTreeBuilder<'a>,
) -> ParseTree<'a> {
