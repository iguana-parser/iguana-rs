...
pub struct LayoutAwareFollowSamePositionScanner<'i, 'arena> {
    pub input: &'i Input,
    vec_arena: &'arena Arena,
    memo: MatchMemo<'arena, MATCH_MEMO_WORDS>,
    match_any_memo: MatchAnyMemo<'arena, MATCH_ANY_SET_WORDS>,
}
impl<'i, 'arena> LayoutAwareFollowSamePositionScanner<'i, 'arena> {
...
impl Scanner for LayoutAwareFollowSamePositionScanner<'_, '_> {
