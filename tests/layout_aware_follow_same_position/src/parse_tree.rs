...
use crate::{grammar, parser::LayoutAwareFollowSamePositionParser};
use iguana_runtime::{
    arena::Arena,
...
pub struct LayoutAwareFollowSamePositionParseTreeBuilder<'a> {
    pub arena: &'a Arena,
}
impl<'a> LayoutAwareFollowSamePositionParseTreeBuilder<'a> {
    pub fn new(tree_arena: &'a Arena) -> Self {
        Self { arena: tree_arena }
    }
}
impl<'a> ParseTreeBuilder<ParseTree<'a>> for LayoutAwareFollowSamePositionParseTreeBuilder<'a> {
...
pub fn create_parse_tree<'a>(
    root_id: SPPFNodeId,
    parser: &LayoutAwareFollowSamePositionParser,
    builder: &LayoutAwareFollowSamePositionParseTreeBuilder<'a>,
) -> ParseTree<'a> {
