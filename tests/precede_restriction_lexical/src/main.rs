...
struct Cli {
    ...
    ext: Option<String>,
    #[doc = "Run the PrecedeRestrictionLexical parser in REPL mode"]
    ///
    ...
    if args.check_sexpr || args.regenerate_sexpr {
        ...
        let passed = cli::run_golden(
            ...
            |path| {
                ...
                let parse_tree_builder = PrecedeRestrictionLexicalParseTreeBuilder::new(&ctx);
                let mut parser = PrecedeRestrictionLexicalParser::new(&input, start_nonterminal_id);
        ...
        for entry in &entries {
            ...
            let report = cli::run_corpus(
                ...
                |path| {
                    ...
                    let mut parser =
                        PrecedeRestrictionLexicalParser::new(&input, start_nonterminal_id);
