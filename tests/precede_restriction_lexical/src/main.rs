...
use precede_restriction_lexical::{
    parse_tree::{PrecedeRestrictionLexicalParseTreeBuilder, create_parse_tree, to_json, to_sexpr},
    parser::{NONTERMINALS, PrecedeRestrictionLexicalParser, SLOTS, TERMINALS},
};
use std::{
    fs::File,
...
fn main() -> Result<(), io::Error> {
    ...
    let start_nonterminal_id = PrecedeRestrictionLexicalParser::nonterminal_id(
    ...
    let parse_tree_builder = PrecedeRestrictionLexicalParseTreeBuilder;
